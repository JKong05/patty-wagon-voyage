      ...
      <div className="flex flex-row">
        {shuffledAnswers.map((answer) => (
          ...
          >
            ...
            <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white transition-transform duration-300 group-hover:scale-110 break-words">
              {answer}
            </span>
          </button>
        ))}
