...
export default function Quiz({
  ...
  return (
    <div
      className={`${difficulty}-wrapper trivia-container mx-auto flex flex-col justify-center items-center h-screen`}
    >
                ...
                {error ? (
                  ...
                  <div className="flex flex-col pb-4">
                    ...
                    <div className="flex flex-col items-center w-full pr-2">
                      <div className="flex">
                        <div>
                          <Conch handleHint={handleHint} />
                        </div>
                        {hint && (
                          <p className="mt-2 text-purple-600 text-center break-words w-5/6">
                            {hint}
                          </p>
                        )}
                      </div>
